        ...
        model_list = [
            ...
            Strategy(
                ...
                model=MonotonicRejectionGP(
                    inducing_points=inducing_points, dim=1, monotonic_idxs=[0]
                ),
        ...
        model_list = [
            ...
            Strategy(
                ...
                model=GPClassificationModel(
                    inducing_points=inducing_points, dim=1, inducing_size=10
                ),
                generator=OptimizeAcqfGenerator(
                    acqf=acqf, lb=lb, ub=ub, acqf_kwargs=extra_acqf_args
                ),
                min_asks=n_opt,
                stimuli_per_trial=1,
                outcome_types=["binary"],
