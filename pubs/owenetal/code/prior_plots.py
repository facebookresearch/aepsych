...
from bayesopt_server.models import GPClassificationModel
from bayesopt_server.factory import (
    default_mean_covar_factory,
    song_mean_covar_factory,
    monotonic_mean_covar_factory,
    conditioning_mean_covar_factory,
)
from botorch_fb.models import MixedDerivativeVariationalGP, MonotonicGP
from bayesopt_server.utils import _dim_grid


def plot_prior_samps_1d():
    config = Config(
        config_dict={
            "common": {"pairwise": False, "target": 0.75, "lb": "[-3]", "ub": "[3]"},
            "default_mean_covar_factory": {},
            "song_mean_covar_factory": {},
