# imports
from bayesopt_server.config import Config
from bayesopt_server.strategy import SequentialStrategy
import torch
...
from bayesopt_server.plotting import plot_strat_2d, plot_strat_1d
import matplotlib.pyplot as plt
from scipy.stats import norm
from bayesopt_server.utils import get_lse_interval, get_lse_contour
import numpy as np
...
def plot_acquisition_examples(sobol_trials, opt_trials, target_level=0.75):
    ...
    configs = {
        ...
        "MonotonicMCLSE": {"target": target_level, "beta": 3.98,},
        "MonotonicGP": {
            "inducing_size": 100,
            "mean_covar_factory": "monotonic_mean_covar_factory",
            "monotonic_idxs": "[0]",
        ...
        "MonotonicSingleProbitBayesOpt": {"restarts": 10, "samps": 1000},
        "SobolStrategy": {"n_trials": sobol_trials},
        "ModelWrapperStrategy": {"n_trials": opt_trials, "refit_every": refit_every,},
    }
